...
export const sidebarItems = [ 
    new SidebarItem (1, 'Dashboard', 'pages/Admin/dashboard/dashboard.module', null, 'fa-home', null, false, 0),
    new SidebarItem (2, 'Item List', 'pages/Admin/items/item_list/item_list.module', null, 'fa-bar-chart', null, false, 0),
