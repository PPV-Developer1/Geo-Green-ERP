  ...
  async Add(value)
   {
       ...
       if(this.form.valid)
       {
           await this.api.post('post_update_data.php?table=debit_note&field=id&value=' + this.Details.id + '&authToken=' + environment.authToken, this.form.value).then(async (data_rt: any) => {
                       console.log(data_rt)
             ...
             table: {
               ...
               body: [
                 [
                   [
                     [
                       { text: ' DEBIT NOTE', fontSize: 11, bold: true, alignment: 'center' },]
                   ],
                 ],
               ]
             },
       ...
       table: {
         ...
         body: [
           [
             ...
             [
               [
                 { text: 'Terms & Conditions of Debit Note:', bold: true, italics: true, fontSize: '10', alignment: 'left' },
                 { text: test.debit_note_terms, margin: [0, 10], italics: true, fontSize: '10', alignment: 'left' },
               ]
             ],
           ],
