    ...
    content: [
...

      {
        table: {
          ...
          body: [
            [
              { text: 'Invoice Number', fillColor: '#CCCCCC', border: [true, true, true, false], fontSize: 12, bold: true , alignment: 'center'},
              { text: 'Invoice Date',fillColor: '#CCCCCC', border: [true, true, true, false], fontSize: 12, bold: true, alignment: 'center' },
              { text: 'Invoice Amount',fillColor: '#CCCCCC', border: [true, true, true, false], fontSize: 12, bold: true, alignment: 'center' },
...
advance_download()
{
  ...
  const docDefinition = {
    ...
    content: [
      ...
      { text: ' CUSTOMER ADVANCE RECEIPT', style: 'header' },
      { text: ' ' },
